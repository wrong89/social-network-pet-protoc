...
func (x *HelloResponse) GetTest() string {
	if x != nil {
		return x.Test
	}
	return ""
...
const file_hello_hello_proto_rawDesc = "" +
	...
	"\x04test\x18\x01 \x01(\tR\x04test2>\n" +
	"\x05Hello\x125\n" +
	"\bSayHello\x12\x13.hello.HelloRequest\x1a\x14.hello.HelloResponseB\x1aZ\x18wrong89.hello.v1;hellov1b\x06proto3"
